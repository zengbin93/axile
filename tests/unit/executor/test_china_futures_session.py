...
@pytest.mark.parametrize(
    ...
    [
        ...
        (datetime(2026, 8, 26, 10, 20, tzinfo=_SHANGHAI), True),
        (datetime(2026, 8, 26, 11, 29, tzinfo=_SHANGHAI), True),
        (datetime(2026, 8, 26, 11, 30, tzinfo=_SHANGHAI), False),
        (datetime(2026, 8, 26, 12, 0, tzinfo=_SHANGHAI), False),
        (datetime(2026, 8, 26, 13, 0, tzinfo=_SHANGHAI), True),
