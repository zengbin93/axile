...
export function SetupHub() {
  return (
    <div className="mx-auto max-w-[1728px] px-12 pt-8 pb-6">
      <div className="mb-1.5 text-xs font-semibold tracking-wide text-accent">设置</div>
      <div className="text-[23px] font-[680] tracking-tight">你想设置什么？</div>
      <div className="mt-1.5 max-w-[560px] text-[15px] text-ink-2">
      ...
      <div className="mt-4 grid grid-cols-1 gap-[18px] md:grid-cols-2">
        ...
        >
          <div className="text-3xl">🔌</div>
          <h3 className="mt-3.5 text-[19px] font-semibold">新建账户</h3>
          <p className="mt-1.5 text-[15px] text-ink-2">连交易所 / 券商，绑定组合，设定交易方式。</p>
          <span className="mt-4 inline-block text-[15px] font-semibold text-accent">开始 →</span>
        </Link>
      </div>
    </div>
