...
export const getCalendarStatus = (calendarId = 'china') =>
  apiGet<CalendarStatus>(`/market/trading-calendar/status?${query(calendarId)}`)
export const getCalendarDiagnostics = (calendarId: string, start: string, end: string) =>
  apiGet<CalendarDiagnostic[]>(`/market/trading-calendar/diagnostics?${query(calendarId)}&start=${start}&end=${end}`)
...
export const getCalendarOverrides = (calendarId = 'china') =>
  apiGet<CalendarOverride[]>(`/market/trading-calendar/overrides?${query(calendarId)}`)
